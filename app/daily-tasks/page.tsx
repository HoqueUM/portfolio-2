    ...
    <div className="min-h-screen relative">     
      ...
      <nav className="top-0 pb-4 pt-4">
        ...
        <div className="flex font-mono">
            ...
            <div><a href="https://www.techinterviewhandbook.org/grind75/?weeks=26&hours=6" target="_blank" className="trace w-min">Leetcode</a> | <a href="/dsa-notes" target="_blank" className="trace w-min">Notes</a></div>
