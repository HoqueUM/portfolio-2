    ...
    <div className="min-h-screen relative">     
      ...
      <nav className="top-0 pb-4 pt-4">
        ...
        <div className="flex font-mono">
            ...
            <div><a href="https://www.techinterviewhandbook.org/grind75/?weeks=26&hours=6" target="_blank" className="trace w-min">Leetcode</a> | <a href="/dsa-notes" target="_blank" className="trace w-min">Notes</a> | <a href="https://docs.google.com/spreadsheets/d/1ZBXHpM3EIJHg3o8dX95TKBTbIu6gsLxU83aF-Aap4oA/edit?gid=0#gid=0" target="_blank" className="trace w-min">Spreadsheet</a></div>
            ...
            <a href="https://rahulhoque.substack.com/publish/home" target="_blank">Substack</a>
        </div>
        </div>
      </main>
    </div>
